...
function App() {
    ...
    const [users, setUsers] = useState(() => {
        ...
        const hasDemoUser = parsedUsers.some(
            (account) => account.email.toLowerCase() === DEFAULT_DEMO_USER.email.toLowerCase()
        );
        return hasDemoUser ? parsedUsers : [...parsedUsers, DEFAULT_DEMO_USER];
    });
